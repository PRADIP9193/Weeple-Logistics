...
(function ($) {
  ...
  if ($(".hidden-bar").length) {
    ...
    $(".hidden-bar .side-menu ul li.dropdown").append(
      '<div class="dropdown-btn"><span class="arrow_carrot-down"></span></div>'
    );
  ...
  if ($(".mobile-menu").length) {
    ...
    // console.log(mobileMenuContent, "thiss");
    // console.log($(".mobile-menu .menu-box .menu-outer"), "here");
    // $(".mobile-menu .menu-box .menu-outer").append(mobileMenuContent);
    // $(".sticky-header .main-menu").append(mobileMenuContent);

    //Dropdown Button
    console.log($(".mobile-menu li.dropdown .dropdown-btn"));
    // let elem = document.getElementsByClassName("dropdown-btn");
